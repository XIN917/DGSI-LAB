...
| `api_server.py` | Complete — 15 endpoints, SSE streaming, session-scoped run registry with elapsed_seconds persistence |
...
- [x] Dashboard UX fixes: scrollable customer orders, log content visibility, log dropdown auto-select, elapsed time in run chips, "fulfilled d0" display fix
